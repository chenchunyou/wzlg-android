...
public class CourseInfoDialog extends Dialog {
    ...
    private TextView tv_course_qqgroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_course_qqgroup = findViewById(R.id.tv_course_qqgroup);

        tv_course_name.setText(course.getName());
        tv_course_classroom.setText(course.getClassroom());
        tv_course_qqgroup.setText(course.getQqGroup());
    }
